...
export default function HelpSupportPage() {
  ...
  return (
    <main className="mx-auto min-h-dvh max-w-[430px] bg-[#f5f7fb] pb-24">
      ...
      <section className="mt-4 bg-white px-4">
        <div className="divide-y divide-slate-100">
          <Link href="/mypage/support/terms" className="flex items-center justify-between py-4 hover:bg-slate-50 transition-colors">
            <span className="text-sm font-bold text-slate-900">利用規約・免責事項</span>
            <span className="text-slate-400 font-bold">&gt;</span>
          </Link>

          <Link href="/mypage/support/contact" className="flex items-center justify-between py-4 hover:bg-slate-50 transition-colors">
            <span className="text-sm font-bold text-slate-900">お問い合わせ</span>
            <span className="text-slate-400 font-bold">&gt;</span>
          </Link>

          <Link href="/mypage/support/report" className="flex items-center justify-between py-4 hover:bg-slate-50 transition-colors">
